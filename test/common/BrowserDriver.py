...
class BrowserDriver(object):
    ...
    def openbrowser(self, driver = None):
        ...
        if browser == "Firefox":
            ...
            #   读取本地google cookie，实现免登录
            # chrome_options.add_argument("user-data-dir=C:\\Users\\a\\AppData\\Local\\Google\\Chrome\\User Data")
            ...
            # option.add_argument(r"--user-data-dir=C:\Users\a\AppData\Local\Google\Chrome\User Data1")
